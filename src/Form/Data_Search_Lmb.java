 ...
 * @author rizqi adnan
 */
public class Data_Search_Lmb extends javax.swing.JFrame {
   ...
   public void getData(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search_Lmb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
